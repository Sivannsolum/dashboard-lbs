    ...
    >
      ...
      >
        <template v-if="(isCollapsed && !isFirstLevel) || !isCollapsed || isMobileItem">
          <span class="vsm--title">{{$t( item.title )}}</span>
        </template>
      </transition>
      <template v-if="(isCollapsed && !isFirstLevel) || !isCollapsed || isMobileItem">
        <sidebar-menu-badge
...
<script>
import { itemMixin, animationMixin } from '@/components/mixin'
import SidebarMenuLink from '@/components/SidebarMenu/SidebarMenuLink.vue'
import SidebarMenuIcon from '@/components/SidebarMenu/SidebarMenuIcon.vue'
import SidebarMenuBadge from '@/components/SidebarMenu/SidebarMenuBadge.vue'
