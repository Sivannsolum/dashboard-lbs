            ...
            <v-col cols="12" sm="9" style="">
               <v-card class="pa-2" outlined tile height="700px">
                  ...
                  <div id="panzoom-element" class="">
                     ...
                     <div>
                        <v-img style="  position:absolute; top: 0px;" max-height="800" src="@/assets/img/FloorPlan.png"></v-img>
                     </div>
                  </div>
               </v-card>
            </v-col>
            <v-col cols="12" sm="3" >
               <v-card class="pb-6 pl-6 pr-6" outlined flat style="background-color: #ececec; max-height: 100%; ">
